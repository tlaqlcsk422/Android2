...
public class PortraitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.add(R.id.portrait_container, new MonthViewFragment());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.month_view:
                FragmentManager fragmentManager = getSupportFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.portrait_container, new MonthViewFragment());
                fragmentTransaction.commit();
            ...
            case R.id.week_view:
                ...
                fragmentTransaction.replace(R.id.portrait_container, new WeekViewFragment());
                fragmentTransaction.commit();
